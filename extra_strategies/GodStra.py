...
class GodStraNew(IStrategy):
    ...
    entry_crossed_indicator0 = CategoricalParameter(god_genes_with_timeperiod, default='ADD-20', space='entry')
    entry_crossed_indicator1 = CategoricalParameter(god_genes_with_timeperiod, default='ASIN-6', space='entry')
    entry_crossed_indicator2 = CategoricalParameter(god_genes_with_timeperiod, default='CDLEVENINGSTAR-50', space='entry')
    entry_indicator0 = CategoricalParameter(god_genes_with_timeperiod, default='SMA-100', space='entry')
    entry_indicator1 = CategoricalParameter(god_genes_with_timeperiod, default='WILLR-50', space='entry')
    entry_indicator2 = CategoricalParameter(god_genes_with_timeperiod, default='CDLHANGINGMAN-20', space='entry')
    entry_operator0 = CategoricalParameter(operators, default='/<R', space='entry')
    entry_operator1 = CategoricalParameter(operators, default='<R', space='entry')
    entry_operator2 = CategoricalParameter(operators, default='CB', space='entry')
    entry_real_num0 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.89009, space='entry')
    entry_real_num1 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.56953, space='entry')
    entry_real_num2 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.38365, space='entry')
    # Sell Hyperoptable Parameters/Spaces.
    exit_crossed_indicator0 = CategoricalParameter(god_genes_with_timeperiod, default='CDLSHOOTINGSTAR-150', space='exit')
    exit_crossed_indicator1 = CategoricalParameter(god_genes_with_timeperiod, default='MAMA-1-100', space='exit')
    exit_crossed_indicator2 = CategoricalParameter(god_genes_with_timeperiod, default='CDLMATHOLD-6', space='exit')
    exit_indicator0 = CategoricalParameter(god_genes_with_timeperiod, default='CDLUPSIDEGAP2CROWS-5', space='exit')
    exit_indicator1 = CategoricalParameter(god_genes_with_timeperiod, default='CDLHARAMICROSS-150', space='exit')
    exit_indicator2 = CategoricalParameter(god_genes_with_timeperiod, default='CDL2CROWS-5', space='exit')
    exit_operator0 = CategoricalParameter(operators, default='<R', space='exit')
    exit_operator1 = CategoricalParameter(operators, default='D', space='exit')
    exit_operator2 = CategoricalParameter(operators, default='/>R', space='exit')
    exit_real_num0 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.09731, space='exit')
    exit_real_num1 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.81657, space='exit')
    exit_real_num2 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.87267, space='exit')
    # Stoploss:
    stoploss = -1
    # Buy hypers
    timeframe = '4h'
