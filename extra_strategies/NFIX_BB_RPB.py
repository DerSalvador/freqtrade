...
class NFIX_BB_RPB(IStrategy):
    ...
    # ~0.11 / 90% / 15.01% / 1:30:00 (W) / S
    # ~0.06 / 90.9% / 12.54% / 10:12:00 (W) / F
    # ~0.10 / 100% / 0% / 4:40:00 (W) / S
    # ~0.03 / 100% / 0% / 1:42:00 (W) / S
    # ~0.31 / 100% / 0% / 1:30:00 (W) / S
    # ~0.08 / 100% / 0% / 1:35:00 (W) / S
    # ~0.03 / 100% / 0% / 1:39:00 (W) / S
    # ~0.12 / 100% / 0% / 1:12:00 (W) / S
    # ~0.22 / 100% / 0% / 2:07:00 (W) / S
    # ~0.15 / 100% / 0% / 1:04:00 (W) / S
    # ~0.22 / 100% / 0% / 0:21:00 (W) / S
    # ~0.09 / 100% / 0% / 0:34:00 (W) / S
    # ~0.10 / 94% / 21.08% / 1:19:00 (W) / S
    # ~0.08 / 100% / 0% / 0:50:00 (W) / S
    # ~0.07 / 92.3% / 11.71% / 4:57:00 (W) / S
    # ~0.01 / 100% / 0% / 1:55:00 (W) / S
    # ~0.11 / 94.7% / 10.94% / 4:11:00 (W) / S
    # ~0.12 / 95.5% / 8.69% / 0:54:00 (W) / S
    # ~0.09 / 100% / 0% / 6:39:00 (W) / F
    # ~0.03 / 100% / 0% / 1:25:00 (W) / S
    # ~0.10 / 100% / 0% / 0:42:00 (W) / S
    # ~0.10 / 94.1% / 12.53% / 3:17:00 (W) / ?
    # ~0.15 / 100% / 0% / 0:55:00 (W) / S
    ## BB_RPB begin
    ## quick mode
    ## BB_RPB end
    # ~0.24 / 97.6% / 6.22% / 1:05:00 (W) / S
    # ~0.24 / 100% / 0% / 1:29:00 (W) / S
    # ~0.11 / 100% / 0% / 1:16:00 (W) / S
    # ~0.24 / 97.6% / 7.37% / 1:21:00 (W) / S
    # ~0.18 / 93.8% / 12.26% / 2:36:00 (W) / S
    # ~0.24 / 95.2% / 24.67% / 4:37:00 (W) / S
    # ~0.49 / 97.7% / 16.71% / 1:39:00 (W) / S
    # ~0.21 / 100% / 16.71% / 2:20:00 (W) / S
    # ~0.41 / 97.3% / 31.2% / 4:53:00 (W) / S
    #############
    entry_params = {'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': True, 'entry_condition_6_enable': True, 'entry_condition_7_enable': True, 'entry_condition_8_enable': True, 'entry_condition_9_enable': True, 'entry_condition_10_enable': True, 'entry_condition_11_enable': True, 'entry_condition_12_enable': True, 'entry_condition_13_enable': True, 'entry_condition_14_enable': True, 'entry_condition_15_enable': True, 'entry_condition_16_enable': True, 'entry_condition_17_enable': True, 'entry_condition_18_enable': True, 'entry_condition_19_enable': True, 'entry_condition_20_enable': True, 'entry_condition_21_enable': True, 'entry_condition_22_enable': True, 'entry_condition_23_enable': True, 'entry_condition_24_enable': True, 'entry_condition_25_enable': True, 'entry_condition_26_enable': True, 'entry_condition_27_enable': True, 'entry_condition_28_enable': True, 'entry_condition_29_enable': True, 'entry_condition_30_enable': True, 'entry_condition_31_enable': True, 'entry_condition_32_enable': True, 'entry_condition_33_enable': True, 'entry_condition_34_enable': True, 'entry_condition_101_enable': True, 'entry_condition_102_enable': True, 'entry_condition_103_enable': True, 'entry_condition_104_enable': True, 'entry_condition_105_enable': True, 'entry_condition_106_enable': True, 'entry_condition_35_enable': True, 'entry_condition_36_enable': True, 'entry_condition_37_enable': True, 'entry_condition_38_enable': True, 'entry_condition_39_enable': True, 'entry_condition_40_enable': True, 'entry_condition_41_enable': True, 'entry_condition_42_enable': True, 'entry_condition_43_enable': True, 'entry_condition_44_enable': True, 'entry_condition_45_enable': True, 'entry_condition_46_enable': True, 'entry_condition_47_enable': True, 'entry_condition_48_enable': True, 'entry_condition_49_enable': True, 'entry_condition_50_enable': True, 'entry_condition_51_enable': True, 'entry_condition_52_enable': True, 'entry_condition_53_enable': True, 'entry_condition_54_enable': True, 'entry_condition_55_enable': True}
    #############
    # Enable/Disable conditions
    #############
    ...
    def exit_stoploss(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        if last_candle['sma_200_dec_20'] and last_candle['ema_vwma_osc_32'] < -0.0 and (last_candle['ema_vwma_osc_64'] < -0.0) and (last_candle['ema_vwma_osc_96'] < -0.0) and (last_candle['cmf'] < -0.0) and (last_candle['cmf_1h'] < -0.0) and (current_time - timedelta(minutes=1440) > trade.open_date_utc):
        ...
        if current_profit < -0.05 and last_candle['close'] < last_candle['ema_200'] * 0.988 and (last_candle['cmf'] < -0.046) and ((last_candle['ema_200'] - last_candle['close']) / last_candle['close'] < 0.022) and (last_candle['rsi_14'] > previous_candle_1['rsi_14']) and (last_candle['rsi_14'] > last_candle['rsi_14_1h'] + 10.0) and last_candle['sma_200_dec_24']:
    ...
    def exit_r(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        if 0.01 > current_profit > 0.001:
            ...
            elif last_candle['r_14'] >= -2.0 and last_candle['r_96'] >= -3.0 and (last_candle['rsi_14'] > 77.0) and (last_candle['cti'] > 0.9):
            ...
            elif last_candle['r_14'] >= -3.0 and last_candle['r_96'] >= -3.0 and (last_candle['rsi_14'] > 76.0) and (last_candle['cti'] > 0.9):
            ...
            elif last_candle['r_14'] >= -4.0 and last_candle['r_96'] >= -3.0 and (last_candle['rsi_14'] > 75.0) and (last_candle['cti'] > 0.85):
            ...
            elif last_candle['r_14'] >= -3.0 and last_candle['r_96'] >= -3.0 and (last_candle['rsi_14'] > 76.0) and (last_candle['cti'] > 0.85):
            ...
            elif last_candle['r_14'] >= -3.0 and last_candle['r_96'] >= -3.0 and (last_candle['rsi_14'] > 77.0) and (last_candle['cti'] > 0.85):
            ...
            elif last_candle['r_480'] > -10.0 and last_candle['rsi_14'] > 80.0 and (last_candle['cti'] > 0.85) and (last_candle['cci'] > 260.0):
            ...
            elif last_candle['r_480'] > -10.0 and last_candle['rsi_14'] > 80.0 and (last_candle['cti'] > 0.85) and (last_candle['cci'] > 280.0):
    ...
    def exit_pump_stoploss(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        ...
        if last_candle['hl_pct_change_36_1h'] > 0.5:
            if -0.05 > current_profit > -0.08 and max_loss < 0.08 and (max_profit > current_profit + 0.1) and (last_candle['close'] < last_candle['ema_200']) and last_candle['sma_200_dec_20'] and last_candle['sma_200_dec_20_1h'] and (last_candle['ema_vwma_osc_32'] < 0.0) and (last_candle['ema_vwma_osc_64'] < 0.0) and (last_candle['ema_vwma_osc_96'] < 0.0) and (last_candle['cmf'] < -0.25) and (last_candle['rsi_14'] < 40.0):
                return (True, 'exit_stoploss_p_36_2_1')
        if last_candle['hl_pct_change_24_1h'] > 0.6:
            if -0.04 > current_profit > -0.08 and max_loss < 0.08 and (last_candle['close'] < last_candle['ema_200']) and last_candle['sma_200_dec_20'] and last_candle['sma_200_dec_20_1h'] and (last_candle['ema_vwma_osc_32'] < 0.0) and (last_candle['ema_vwma_osc_64'] < 0.0) and (last_candle['ema_vwma_osc_96'] < 0.0) and (last_candle['cmf'] < -0.25):
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float, current_profit: float, **kwargs):
        ...
        if all((c in ['31', '32', '33', '34', '35', '36'] for c in entry_tags)):
            ...
            return None
        # Quick exit mode
        if all((c in ['empty', '104', '105'] for c in entry_tags)):
        ...
        for index in self.entry_protection_params:
            ...
            if self.entry_params[f'entry_condition_{index}_enable']:
                ...
                # Condition #2 - Semi swing. Local dip.
                    ...
                    # Non-Standard protections
                    # Logic
                    item_entry_logic.append(dataframe['rsi_14'] < dataframe['rsi_14_1h'] - 47.5)
                    item_entry_logic.append(dataframe['mfi'] < 46.0)
                    ...
                    item_entry_logic.append(dataframe['r_480'] < -20.0)
                ...
                # Condition #5 - Semi swing. Local dip. Uptrend.
                    ...
                    item_entry_logic.append(dataframe['ewo'] > 3.6)
                ...
                # Condition #15 - Semi swing. Uptrend. Local dip.
                    ...
                    item_entry_logic.append(dataframe['cti_1h'] < 0.6)
                ...
                # Condition #26 - Semi swing. Local deep dip.
                    ...
                    item_entry_logic.append(dataframe['rsi_4'] < 46)
                    item_entry_logic.append(dataframe['close'] < dataframe['sma_15'] * 0.93)
                    item_entry_logic.append(dataframe['rsi_14'] > 19.0)
                ...
                # ewo2 (need more protection)
                    ...
                    item_entry_logic.append(dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12))
                    item_entry_logic.append(dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24))
                    item_entry_logic.append(dataframe['roc_1h'] < 86)
                    item_entry_logic.append(dataframe['bb_width_1h'] < 0.954)
                    # Logic
                    item_entry_logic.append(dataframe['rsi_4'] < 45)
                    item_entry_logic.append(dataframe['close'] < dataframe['ema_8'] * 0.97)
                    item_entry_logic.append(dataframe['ewo'] > 4.179)
                    item_entry_logic.append(dataframe['close'] < dataframe['ema_16'] * 1.087)
                    item_entry_logic.append(dataframe['rsi_14'] < 35)
                # ewo
                elif index == 102:
                    # Non-Standard protections
                    item_entry_logic.append(dataframe['roc_1h'] < 86)
                    item_entry_logic.append(dataframe['bb_width_1h'] < 0.954)
                    # Logic
                    item_entry_logic.append(dataframe['rsi_4'] < 44)
                    ...
                    item_entry_logic.append(dataframe['rsi_14'] < 23)
                # BB safe dump
                elif index == 103:
                    # Logic
                    item_entry_logic.append(dataframe['rmi_17'] < 49)
                    item_entry_logic.append(dataframe['cci_25'] <= -116)
                    item_entry_logic.append(dataframe['srsi_fk'] < 32)
                    item_entry_logic.append(dataframe['bb_delta'] > 0.025)
                    item_entry_logic.append(dataframe['bb_width'] > 0.095)
                    item_entry_logic.append(dataframe['closedelta'] > dataframe['close'] * 12.148 / 1000)
                    item_entry_logic.append(dataframe['close'] < dataframe['bb20_3_low'] * 0.999)
                # NFI 33
                elif index == 104:
                    # Logic
                    item_entry_logic.append(dataframe['close'] < dataframe['ema_13'] * 0.978)
                    item_entry_logic.append(dataframe['ewo'] > 8)
                    item_entry_logic.append(dataframe['cti'] < -0.88)
                    item_entry_logic.append(dataframe['rsi_14'] < 32)
                    item_entry_logic.append(dataframe['r_14'] < -98.0)
                    item_entry_logic.append(dataframe['volume'] < dataframe['volume_mean_4'] * 2.5)
                # NFI 38
                elif index == 105:
                    # Non-Standard protections
                    # Logic
                ...
                # reverse deadfish
                    ...
                    item_entry_logic.append(dataframe['bb_width'] > 0.3)
                    item_entry_logic.append(dataframe['close'] < dataframe['bb20_2_mid'] * 1.014)
                    item_entry_logic.append(dataframe['volume_mean_12'] > dataframe['volume_mean_24'] * 1.59)
                    item_entry_logic.append(dataframe['cti'] < -0.115)
                    item_entry_logic.append(dataframe['r_14'] < -44.34)
                ...
                # Condition #42 - 15m. Semi swing. Local dip. 15m uptrend.
                    ...
                    item_entry_logic.append(dataframe['cci_15m'] < -160.0)
                ...
                # Condition #43 - 15m. Semi swing. Local dip. 1h uptrend.
                    ...
                    item_entry_logic.append(dataframe['closedelta_15m'].gt(dataframe['close_15m'] * 0.032))
                ...
                # Condition #49 - 15m. Semi swing. Local deeper dip.
                    ...
                    item_entry_logic.append(dataframe['ema_26_15m'].shift(3) - dataframe['ema_12_15m'].shift(3) > dataframe['open_15m'] / 100)
                    item_entry_logic.append(dataframe['close_15m'] < dataframe['ema_20_15m'] * 0.916)
                    item_entry_logic.append(dataframe['rsi_14_15m'] < 32.5)
                ...
                # Condition #53 - 15m. Semi swing. BTC not negative. Local dip.
                    ...
                    # Logic
                    item_entry_logic.append(dataframe['ema_26_15m'] > dataframe['ema_12_15m'])
                    item_entry_logic.append(dataframe['ema_26_15m'] - dataframe['ema_12_15m'] > dataframe['open_15m'] * 0.0198)
                    item_entry_logic.append(dataframe['ema_26_15m'].shift(3) - dataframe['ema_12_15m'].shift(3) > dataframe['open_15m'] / 100)
                    item_entry_logic.append(dataframe['close_15m'] < dataframe['bb20_2_low_15m'] * 0.99)
                    item_entry_logic.append(dataframe['r_14'] < -90.0)
